                    ...
                    <div class="card shadow-lg o-hidden border-0 my-5">
                        <div class="card-body p-0">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="p-5">
                                        ...
                                        <form class="user" action="userlogincheak.php" method="POST">
									...
									if (isset($_SESSION['ulmsg'])) {
										$msg2 = $_SESSION['ulmsg'];
									
									?>
									<h4 class="text-dark mb-4"><?php echo $msg2 ?></h4>
									
								<?php  unset($_SESSION['ulmsg']); } 
							...
							<?php  unset($_SESSION['em1']); } 
								if (isset($_SESSION['em2'])) {
									$em2 = $_SESSION['em2'];
								
								?>
									<h4 class="text-dark mb-4"><?php echo $em2 ?></h4>
								
							<?php  unset($_SESSION['em2']); } 
