    ...
    <div class="pb-5">
      <div class="container">
                    ...
                    <tbody>
                      <tr>
                        <th scope="row" class="border-0">
                          <div class="p-2">
                            <img src="<?php echo $image ?>" width="70" class="img-fluid rounded shadow-sm">
                        ...
                        <td class="border-0 align-middle"><strong>
                            ...
                            <div class="input-group">
                              <input type="button" value="-"<?php echo $qty ?>" class="button-minus border rounded-circle  icon-shape icon-sm mx-1 " data-field="quantity">
                        ...
                        <td class="border-0 align-middle"><a href="deletecartitem.php?id=<?php echo $id; ?>" class="text-dark"><i class="fa fa-trash"></i></a></td>
                      </tr>
                  <?php
                  }
                }
        ...
        <div class=" align-items-right">
         ...
         <a href="clearcart.php" class="btn btn-primary shadow rounded-pill py-2 btn-block">Clear</a>
       </div>
        ...
        <div class="col-lg-6">
          ...
          <div class="p-4">
            ...
            <ul class="list-unstyled mb-4">
              ...
              <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Tax</strong><strong>3%</strong></li>
              <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Total</strong>
                <h5 class="font-weight-bold">৳<?php echo $sum + ($sum * (3 / 100)) ?></h5>
              </li>
            </ul><a href="checkout.php" class="btn btn-primary shadow rounded-pill py-2 btn-block">Checkout</a>
          </div>
        </div>
      </div>
...
<footer class="text-center py-4">
  <div class="container">
    <div class="row row-cols-1 row-cols-lg-3">
      <div class="col">
        <p class="text-muted my-2">Copyright&nbsp;© 2022 Elite Explorer</p>
      </div>
      <div class="col">
