        ...
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="/">
                ...
                <span class="bs-icon-sm bs-icon-circle bs-icon-primary shadow d-flex justify-content-center align-items-center me-2 bs-icon">
                    ...
                    <span>Elite Explorer</span></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                                ...
                                <div class="col-lg-12">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <h4 class="text-dark mb-4">ADMIN LOGIN HERE!</h4>
                                        </div>
                                        <form class="user" action="adminlogincheck.php" method="POST">
                                            <div class="mb-3"><input class="form-control form-control-user" type="email" name ="email" id="email" aria-describedby="emailHelp" placeholder="Enter Email Address" name="email" required=""></div>
                                            <div class="mb-3"><input class="form-control form-control-user" type="password" name = "password" placeholder="Password" name="password" required=""></div>
                                            <div class="row mb-3">
                                                <p id="errorMsg" class="text-danger" style="display:none;">Paragraph</p>
                                            </div><button class="btn btn-primary d-block btn-user w-100" id="submitBtn" type="submit" name= "submit">Login</button>
                                            ...
                                            <div class="text-center">
                                                ...
                                                <?php
                                                        ...
                                                        if (isset($_SESSION['almsg'])) {
                                                            $msg2 = $_SESSION['almsg'];
                                                        
                                                        ?>
                                                      	<h4 class="text-dark mb-4"><?php echo $msg2 ?></h4>
                                                        
                                                    <?php  unset($_SESSION['almsg']); } 
                                                ?>
                                            </div>
                                        ...
                                        <div class="text-center"><a class="small" href="login.php">User Login!</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
