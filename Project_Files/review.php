...
<body style="/*background: url(&quot;design.jpg&quot;);*/background-position: 0 -60px;">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navcol-1">
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item"><a class="nav-link active" href="review.php">Blog</a></li>
        ...
        if (isset($_SESSION['email'])) { ?>
          ...
          <a href="userlogout.php"><i class="fas fa-power-off mr-2"></i> Logout</a>
  ...
  <div class="testimonials">
    ...
    <div class="inner">
      ...
      <?php if (isset($_SESSION['r_msg'])) {
        echo $_SESSION['r_msg'];
        unset($_SESSION['r_msg']);
      }
      ?>
      <h1>Here is what our customer says</h1>
      ...
      <div class="row">
        ...
        if (isset($_SESSION['email'])) {
          ...
          $records = mysqli_query($link, "SELECT r.rating,r.msg , u.full_Name,u.dp from review r, users u WHERE r.user_email = u.email ");
        ...
        ?>
            ...
            <div class="col">
              <div class="testimonial">
                ...
                <div class="name"><?php echo $rows['full_Name'] ?></div>
