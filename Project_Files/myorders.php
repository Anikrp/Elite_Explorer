        ...
        <div class="px-4 px-lg-0">
            ...
            <div class="pb-5">
                    ...
                    <div class="row">
                        <div class="col-lg-12 p-5 bg-white rounded shadow-sm mb-5">
                            ...
                            <div class="table-responsive ">
                                <table class="table">
                                    <div class="p-2 px-3 text-uppercase">My Orders:</div>
                                    <hr>
                                    <thead>
                                        <tr>
                ...
                if (isset($_SESSION['email'])) {
                  ...
                  $sql = "SELECT a.*, t.trip_name,t.image from orders a,trip_package t WHERE a.p_id = t.id and a.user_id = '$u_id' ORDER BY a.timestamp DESC";
                   ...
                   ?>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="border-dark align-middle"><strong>Completed</strong></td>
                                        </tr>
